                                        ...
                                        <ul>
                                            {Object.keys(popularlist).length > 0 ? (
                                                popularlist.map(popularlist => (
                                                    <li onClick={() => MvRead(popularlist)}><div><img src={`${popularlist.c_thumbnails}`} alt="morning"/><p>{popularlist.c_name}</p></div></li>
                                                ))
                                            ) : (
                                                <>
                                    ...
                                    <div class="challenge_list">
                                        <ul>
                                            {Object.keys(mylist).length > 0 ? (
                                                mylist.map(mylist => (
                                                    <li onClick={() => MvRead(mylist)}><div><img src={`${mylist.c_thumbnails}`} alt="morning"/><p>{mylist.c_name}</p></div></li>
                                                ))
                                            ) : (
